...
//#include <x_IotWebConfCompatibility.h>
...
#define IOTWEBCONF_CONFIG_START 50
...
const char IOTWEBCONF_HTTP_FORM_END[] PROGMEM     = "</fieldset><button type='submit'>Anwenden</button></form>";
const char IOTWEBCONF_HTTP_SAVED[] PROGMEM        = "<div>Kondiguration gespeichert<br />Gehe zur&uumlck zur <a href='/'>Start-Seite</a>.</div>";
...
const char IOTWEBCONF_HTTP_CONFIG_VER[] PROGMEM   = "<div style='font-size: .6em;'>Firmware Konfig-Version '{v}'</div>";
